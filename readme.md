...
A super simple crate which queries the supported operating system for the number of bytes used. For Unix-like systems, `rusage.ru_maxrss` is used. If your desired operating system isn't supported, please [file an issue](https://github.com/rjzak/app-memory-usage-fetcher/issues).
